						...
						<div class="box-body box-profile">
							<div class="col-md-12 col-xs-12">
								@if($Persona->ID_Cli == $IDClienteSegunUsuario || in_array(Auth::user()->UsRol, Permisos::PROGRAMADOR))
									<a href="/personal/{{$Persona->PersSlug}}/edit" class="btn btn-warning pull-right"><i class="fas fa-edit"></i><b> {{ __('adminlte::message.edit') }}</b></a>
							...
							<ul class="list-group list-group-unbordered">
								...
								<li class="list-group-item">
									<b>{{ __('adminlte::message.address') }}</b> <a title="Copiar" onclick="copiarAlPortapapeles('addresscopy')"><i class="far fa-copy"></i></a>
									<a href="#" class="pull-right textpopover" title='{{ __('adminlte::message.address') }} ' data-toggle="popover" id="addresscopy" data-trigger="focus" data-html="true" data-placement="bottom" data-content="<p class='textolargo'>{{$Persona->PersAddress}}</p>">{{$Persona->PersAddress <> null ? $Persona->PersAddress : 'N/A'}}</a>
								</li>
								<li class="list-group-item">
									<b>{{ __('adminlte::message.personalcarg') }}</b> <a class="pull-right textpopover">{{$Persona->CargName}}</a>
								</li>
								<li class="list-group-item">
								...
								<li class="list-group-item">
									<b>{{ __('adminlte::message.User') }}</b>
									<a href="#" class="pull-right" title="{{ __('adminlte::message.persadminCliente') }}" id="UserAdmin" >
