                    ...
                    <table id="reporteTable" class=" table-compact table-bordered">
                        ...
                        <tbody id="readyTable">
                            @foreach ($servicios as $servicio)
                                <th>{{$servicio->SolSerRMs}}</th>
                                <th>{{$servicio->ID_SolSer}}</th>
                                <th>{{$servicio->ProgVehSalida}}</th>
                                <th>{{$servicio->CliName}}</th>
                                <th>{{$servicio->CliNit}}</th>
                                <th>{{$servicio->SolSerCollectAddress}}</th>
                                <th>{{$servicio->RespelName}}</th>
                                <th>{{$servicio->RespelEstado}}</th>
                                @if($servicio->YRespelClasf4741 <> null)
                                    <th>{{$servicio->YRespelClasf4741}}</th>
                                @elseif($servicio->ARespelClasf4741 <> null)
                                    <th>{{$servicio->ARespelClasf4741}}</th>
                                @else()
                                    <th>{{'N/A'}}</th>
                                @endif
                                <th>{{$servicio->TratName}}</th>
                                <th>{{$servicio->SolResKgEnviado}}</th>
                                <th>{{$servicio->SolResKgRecibido}}</th>
                                <th>{{$servicio->SolResKgConciliado}}</th>
                                <th>{{$servicio->SolNumeroFactura}}</th>
                                <th>{{$servicio->PersFirstName. ' '.$servicio->PersSecondName. ' '. $servicio->PersLastName }}</th>
                                <th></th>
                                <th></th>
                                <th></th>
                                <th></th>
