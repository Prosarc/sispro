    ...
    <div id="app" v-cloak>
        <div class="login-box">
            <div class="login-logo">
                <a href="{{ url('/home') }}"><b>Sig</b>RESPEL</a>
            </div><!-- /.login-logo -->
            ...
            <div class="login-box-body">
                ...
                <form action="{{ url('/login') }}" method="post">
                    ...
                    {{--<input type="email" class="form-control" placeholder="{{ __('adminlte::message.email') }}" name="email"/>--}}
                    ...
                    <div class="row">
                        <div class="col-xs-8">
                            <div class="checkbox icheck">
                                <label>
                                    <input style="display:none;" type="checkbox" name="remember"> {{ __('adminlte::message.remember') }}
                                </label>
                            </div>
                        </div><!-- /.col -->
                        <div class="col-xs-4">
                            <button type="submit" class="btn btn-primary btn-block btn-flat">{{ __('adminlte::message.buttonsign') }}</button>
                        </div><!-- /.col -->
                    </div>
                </form>
