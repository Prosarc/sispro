											...
											<div class="col-md-12">
												<div id="form-step-0" role="form" data-toggle="validator">
													...
													<div class="form-group col-md-6" id="Persfacturacion" >
														<label for="Persadmin" data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>{{ __('adminlte::message.persadminlabel') }}</b>" data-content="{{ __('adminlte::message.persadmininfo') }}"><i style="font-size: 1.7rem; color: Dodgerblue;" class="fas fa-info-circle fa-2x fa-spin"></i>{{ __('adminlte::message.persadminlabel') }}</label><a class="loadFK_PersCargo"></a>
														<small class="help-block with-errors">*</small>
													...
													@if(($IdPersonaAdmin[0]->ID_Pers == Auth::user()->FK_UserPers)&&($Persona->ID_Pers !== Auth::user()->FK_UserPers))
													<div class="form-group col-md-6" id="Persfacturacion" >
														<label for="Persfactura" data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>{{ __('adminlte::message.persfacturalabel') }}</b>" data-content="{{ __('adminlte::message.persfacturainfo') }}"><i style="font-size: 1.7rem; color: Dodgerblue;" class="fas fa-info-circle fa-2x fa-spin"></i>{{ __('adminlte::message.persfacturalabel') }}</label><a class="loadFK_PersCargo"></a>
														<small class="help-block with-errors">*</small>
												...
												<div id="form-step-1" role="form" data-toggle="validator">
													<div class="form-group col-md-6">
														...
														<select name="PersDocType" id="PersDocType" class="form-control">
															<option {{$Persona->PersDocType == 'CC' ? 'selected' : ''}} value="CC">{{ __('adminlte::message.persdoctypecc') }}</option>
															<option {{$Persona->PersDocType == 'CE' ? 'selected' : ''}} value="CE">{{ __('adminlte::message.persdoctypece') }}</option>
															<option {{$Persona->PersDocType == 'NIT' ? 'selected' : ''}} value="NIT">{{ __('adminlte::message.persdoctypenit') }}</option>
															<option {{$Persona->PersDocType == 'RUT' ? 'selected' : ''}} value="RUT">{{ __('adminlte::message.persdoctyperut') }}</option>
														</select>
													</div>
													<div class="form-group col-md-6">
													...
													<div class="form-group col-md-6">
														<label for="PersEmail" data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>{{ __('adminlte::message.emailaddress') }}</b>" data-content="{{ __('adminlte::message.persinfoemailextr') }}"><i style="font-size: 1.7rem; color: Dodgerblue;" class="fas fa-info-circle fa-2x fa-spin"></i>{{ __('adminlte::message.emailaddress') }}</label>
														<small class="help-block with-errors">*</small>
													...
													<div class="form-group col-md-6">
														...
														<div class="input-group">
															...
															<input data-minlength="12" required name="PersCellphone" autofocus="true" type="tel" class="form-control mobile" id="PersCellphone" placeholder="{{ __('adminlte::message.mobileplaceholder') }}" value="{{$Persona->PersCellphone}}">
														</div>
													</div>
													<div class="form-group col-md-6">
														<label for="PersAddress" data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>{{ __('adminlte::message.address') }}</b>" data-content="{{ __('adminlte::message.persinfodir') }} <b>(Opcional)</b>"><i style="font-size: 1.7rem; color: Dodgerblue;" class="fas fa-info-circle fa-2x fa-spin"></i>{{ __('adminlte::message.address') }}</label>
														<input name="PersAddress" autofocus="true" type="text" class="form-control" id="PersAddress" placeholder="{{ __('adminlte::message.addressplaceholder') }}" value="{{$Persona->PersAddress}}">
													</div>
