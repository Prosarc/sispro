												...
												<div class="col-md-12">
													<div id="form-step-1" role="form" data-toggle="validator">
														...
														<div class="form-group col-md-6">
															...
															<input name="PersAddress" autofocus="true" type="text" class="form-control" id="PersAddress" placeholder="{{ __('adminlte::message.addressplaceholder') }}" value="{{old('PersAddress')}}">
														</div>
													</div>
												</div>
