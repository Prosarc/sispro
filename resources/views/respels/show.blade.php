					...
					<ul class="list-group list-group-unbordered">
						...
						<li class="list-group-item">
							...
							<select disabled class="form-control">
								...
								<option {{$Respels->RespelStatus == 'Cotizado' ? 'selected' : '' }}>{{ __('adminlte::LangRespel.respelstatuscotizado') }}</option>
								...
								<option {{$Respels->RespelStatus == 'Falta TDE' ? 'selected' : '' }}>{{ __('adminlte::LangRespel.respelstatusfaltatde') }}</option>
								<option {{$Respels->RespelStatus == 'TDE actualizada' ? 'selected' : '' }}>{{ __('adminlte::LangRespel.respelstatustdeupdated') }}</option>
								<option {{$Respels->RespelStatus == 'Revisado' ? 'selected' : '' }}>{{ __('adminlte::LangRespel.respelstatusrevisado') }}</option>
							</select>
						</li>
						<li class="list-group-item">
			...
			<div class="box">
				...
				<div class="box-header with-border">
					...
					@if($editButton == 'Editable')
							...
							@endif
					@else
							<a data-placement="bottom" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>Edicion Deshabilitada</b>" data-content="<p style='width: 50%'> Editar la información del Residuo solo es permitido si su estatus se encuentra en <i><b>'Pendiente'</b></i> o <i><b>'Incompleto'</b></i>... <br>Para mas detalles comuníquese con su <b>Asesor Comercial</b> </p>" disabled class="btn btn-default">{{ __('adminlte::message.edit') }}</a>
					@endif
						</div>
				</div>
				<!-- /.box header -->
