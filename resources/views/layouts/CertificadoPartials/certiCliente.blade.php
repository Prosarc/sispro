	...
	<div class="box box-primary">
		<div class="box-body box-profile">
			...
			<li class="list-group-item">
				<b>{{ __('adminlte::message.clientcategoría') }}</b> <a class="pull-right">{{$certificado->cliente->CliCategoria}}</a>
			</li>
			<li class="list-group-item">
				<b>{{ __('adminlte::message.clirazonsoc') }}</b> <a class="pull-right">{{$certificado->cliente->CliName}}</a>
			</li>
			{{-- <li class="list-group-item">
				<b>{{ __('adminlte::message.clientnombrecorto') }}</b> <a class="pull-right">{{$certificado->cliente->CliShortname}}</a>
			</li> --}}
			<li class="list-group-item">
				<b>{{ __('adminlte::message.clientNIT') }}</b> <a class="pull-right">{{$certificado->cliente->CliNit}}</a>
			</li>
		</div>
