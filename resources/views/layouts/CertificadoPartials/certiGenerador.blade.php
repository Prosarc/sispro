				...
				<div class="box-body box-profile">
					<div class="col-md-12 col-xs-12">
						{{-- @if (in_array(Auth::user()->UsRol, Permisos::CLIENTE) ||in_array(Auth::user()->UsRol, Permisos::PROGRAMADOR))
							<a href="/generadores/{{$certificado->sedegenerador->generadors->GenerSlug}}/edit" class="btn btn-warning pull-right"> <i class="fas fa-edit"></i> <b>{{ __('adminlte::message.edit') }}</b></a>
						@endif --}}
						...
						{{-- @if($certificado->sedegenerador->generadors->GenerDelete == 0)
							@if(in_array(Auth::user()->UsRol, Permisos::CLIENTE) ||in_array(Auth::user()->UsRol, Permisos::PROGRAMADOR))
								<a method='get' href='#' data-toggle='modal' data-target='#myModal{{$certificado->sedegenerador->generadors->GenerSlug}}' class='btn btn-danger pull-left'><i class="fas fa-trash-alt"></i><b> {{ __('adminlte::message.delete') }}</b></a>
					...
					<ul class="list-group list-group-unbordered">
						{{-- @if (in_array(Auth::user()->UsRol, Permisos::TODOPROSARC) || in_array(Auth::user()->UsRol2, Permisos::TODOPROSARC))
							<li class="list-group-item">
								<b>Generador</b> 
								<a href="#" class="pull-right textpopover" title="{{ __('adminlte::message.clientcliente') }}" data-toggle="popover" data-trigger="hover" data-html="true" data-placement="bottom" data-content="<p class='textolargo'>{{$certificado->sedegenerador->generadors->GenerName}}</p>">{{$certificado->sedegenerador->generadors->GenerName}}</a>
							</li>
						@endif --}}
						<li class="list-group-item">
							<b>{{ __('adminlte::message.clirazonsoc') }}</b> 
							<a href="#" class="pull-right textpopover" title="{{ __('adminlte::message.clirazonsoc') }}" data-toggle="popover" data-trigger="hover" data-html="true" data-placement="bottom" data-content="<p class='textolargo'>{{$certificado->sedegenerador->generadors->GenerName}}</p>">{{$certificado->sedegenerador->generadors->GenerName}}</a>
						</li>
						<li class="list-group-item">
							<b>{{ __('adminlte::message.sclientsede') }}</b> 
							<a href="#" class="pull-right textpopover" title="{{ __('adminlte::message.sclientsede') }}" data-toggle="popover" data-trigger="hover" data-html="true" data-placement="bottom" data-content="<p class='textolargo'>{{$certificado->sedegenerador->GSedeName}}</p>">{{$certificado->sedegenerador->GSedeName}}</a>
						</li>
						<li class="list-group-item">
						...
						{{-- <li class="list-group-item">
							...
							<a href="#" class="pull-right textpopover" title="{{ __('adminlte::message.clientnombrecorto') }}" data-toggle="popover" data-trigger="hover" data-html="true" data-placement="bottom" data-content="<p class='textolargo'>{{$certificado->sedegenerador->generadors->GenerShortname}}</p>">{{$certificado->sedegenerador->generadors->GenerShortname}}</a>
						</li> --}}
						<li class="list-group-item">
							<b>{{ __('adminlte::message.genercode') }}</b> 
							<a href="#" class="pull-right textpopover" title="{{ __('adminlte::message.genercode') }}" data-toggle="popover" data-trigger="hover" data-html="true" data-placement="bottom" data-content="<p class='textolargo'>{{$certificado->sedegenerador->generadors->GenerCode}}</p>">{{$certificado->sedegenerador->generadors->GenerCode}}</a>
						</li>
						{{-- @if (in_array(Auth::user()->UsRol, Permisos::TODOPROSARC) ||in_array(Auth::user()->UsRol2, Permisos::TODOPROSARC)) --}}
						...
						<div style='overflow-y:auto; max-height:300px;'>
								<li class="list-group-item col-md-12 col-xs-12">
									<div class="col-md-6 col-xs-6">
										...
										<a title="{{ __('adminlte::message.copy') }}" onclick="copiarAlPortapapeles('SGeneraddress')"><i class="far fa-copy"></i></a>
									</div>
									<div>
										<p href="#" class="pull-right textpopoveraddress" id="SGeneraddress" title="<b>{{ __('adminlte::message.address') }}</b>" data-toggle="popover" data-trigger="hover" data-html="true" data-placement="bottom" data-content="<p class='textolargo'>{{$certificado->sedegenerador->GSedeAddress}} ({{$certificado->sedegenerador->municipio->MunName}}, {{$certificado->sedegenerador->municipio->Departamento->DepartName}})</p>">{{$certificado->sedegenerador->GSedeAddress}} ({{$certificado->sedegenerador->municipio->MunName}}, {{$certificado->sedegenerador->municipio->Departamento->DepartName}})</p>
									</div>
								</li>
								<li  class="list-group-item col-md-12 col-xs-12">
									<div class="col-md-6 col-xs-6">
										...
										<a title="{{ __('adminlte::message.copy') }}" onclick="copiarAlPortapapeles('GSedePhone1')"><i class="far fa-copy"></i></a>
									</div>
									<div>
								...
								<li  class="list-group-item col-md-12 col-xs-12">
									<div class="col-md-6 col-xs-6">
										...
										<a title="{{ __('adminlte::message.copy') }}" onclick="copiarAlPortapapeles('GSedePhone2')"><i class="far fa-copy"></i></a>
									</div>
									<div>
								...
								<li  class="list-group-item col-md-12 col-xs-12">
									<div class="col-md-6 col-xs-6">
										...
										<a title="{{ __('adminlte::message.copy') }}" onclick="copiarAlPortapapeles('GSedeEmail')"><i class="far fa-copy"></i></a>
									</div>
									<div>
								...
								<li  class="list-group-item col-md-12 col-xs-12">
									<div class="col-md-6 col-xs-6">
										...
										<a title="{{ __('adminlte::message.copy') }}" onclick="copiarAlPortapapeles('GSedeCelular')"><i class="far fa-copy"></i></a>
									</div>
									<div>
