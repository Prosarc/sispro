				...
				<div class="box-body box-profile">
					<div class="col-md-12 col-xs-12">
						{{-- @if (in_array(Auth::user()->UsRol, Permisos::CLIENTE) ||in_array(Auth::user()->UsRol, Permisos::PROGRAMADOR))
							<a href="/generadores/{{$manifiesto->sedegenerador->generadors->GenerSlug}}/edit" class="btn btn-warning pull-right"> <i class="fas fa-edit"></i> <b>{{ __('adminlte::message.edit') }}</b></a>
						@endif --}}
						...
						{{-- @if($manifiesto->sedegenerador->generadors->GenerDelete == 0)
							@if(in_array(Auth::user()->UsRol, Permisos::CLIENTE) ||in_array(Auth::user()->UsRol, Permisos::PROGRAMADOR))
								<a method='get' href='#' data-toggle='modal' data-target='#myModal{{$manifiesto->sedegenerador->generadors->GenerSlug}}' class='btn btn-danger pull-left'><i class="fas fa-trash-alt"></i><b> {{ __('adminlte::message.delete') }}</b></a>
					...
					<ul class="list-group list-group-unbordered">
						{{-- @if (in_array(Auth::user()->UsRol, Permisos::TODOPROSARC) || in_array(Auth::user()->UsRol2, Permisos::TODOPROSARC))
							<li class="list-group-item">
								<b>Generador</b> 
								<a href="#" class="pull-right textpopover" title="{{ __('adminlte::message.clientcliente') }}" data-toggle="popover" data-trigger="hover" data-html="true" data-placement="bottom" data-content="<p class='textolargo'>{{$manifiesto->sedegenerador->generadors->GenerName}}</p>">{{$manifiesto->sedegenerador->generadors->GenerName}}</a>
							</li>
						@endif --}}
						<li class="list-group-item">
							<b>{{ __('adminlte::message.clirazonsoc') }}</b> 
							<a href="#" class="pull-right textpopover" title="{{ __('adminlte::message.clirazonsoc') }}" data-toggle="popover" data-trigger="hover" data-html="true" data-placement="bottom" data-content="<p class='textolargo'>{{$manifiesto->sedegenerador->generadors->GenerName}}</p>">{{$manifiesto->sedegenerador->generadors->GenerName}}</a>
						</li>
						<li class="list-group-item">
							<b>{{ __('adminlte::message.sclientsede') }}</b> 
							<a href="#" class="pull-right textpopover" title="{{ __('adminlte::message.sclientsede') }}" data-toggle="popover" data-trigger="hover" data-html="true" data-placement="bottom" data-content="<p class='textolargo'>{{$manifiesto->sedegenerador->GSedeName}}</p>">{{$manifiesto->sedegenerador->GSedeName}}</a>
						</li>
						<li class="list-group-item">
						...
						{{-- <li class="list-group-item">
							...
							<a href="#" class="pull-right textpopover" title="{{ __('adminlte::message.clientnombrecorto') }}" data-toggle="popover" data-trigger="hover" data-html="true" data-placement="bottom" data-content="<p class='textolargo'>{{$manifiesto->sedegenerador->generadors->GenerShortname}}</p>">{{$manifiesto->sedegenerador->generadors->GenerShortname}}</a>
						</li> --}}
						<li class="list-group-item">
							<b>{{ __('adminlte::message.genercode') }}</b> 
							<a href="#" class="pull-right textpopover" title="{{ __('adminlte::message.genercode') }}" data-toggle="popover" data-trigger="hover" data-html="true" data-placement="bottom" data-content="<p class='textolargo'>{{$manifiesto->sedegenerador->generadors->GenerCode}}</p>">{{$manifiesto->sedegenerador->generadors->GenerCode}}</a>
						</li>
						{{-- @if (in_array(Auth::user()->UsRol, Permisos::TODOPROSARC) ||in_array(Auth::user()->UsRol2, Permisos::TODOPROSARC)) --}}
