		...
		{{-- <div id="form-step-0" role="form" data-toggle="validator"> --}}
			...
			<div class="col-md-6 form-group has-feedback">
				...
				<select id="selectDanger0" name="RespelIgrosidad" class="form-control" required>
					...
					<option value = "{{ __('adminlte::LangRespel.danger1')}}" {{ ($Respels->RespelIgrosidad == 'No peligroso' ? 'selected' : '' )}} onclick="setNoDanger(0)">
						{{ __('adminlte::LangRespel.danger1') }}
					</option>

					<option value = "{{ __('adminlte::LangRespel.danger2')}}" {{ ($Respels->RespelIgrosidad == __('adminlte::LangRespel.danger2') ? 'selected' : '') }} onclick="setDanger(0)">
						{{ __('adminlte::LangRespel.danger2') }}
					</option>

					<option value = "{{ __('adminlte::LangRespel.danger3')}}" {{ ($Respels->RespelIgrosidad == __('adminlte::LangRespel.danger3') ? 'selected' : '') }} onclick="setDanger(0)">
						{{ __('adminlte::LangRespel.danger3') }}
					</option>

					<option value = "{{ __('adminlte::LangRespel.danger4')}}" {{ ($Respels->RespelIgrosidad == __('adminlte::LangRespel.danger4') ? 'selected' : '') }} onclick="setDanger(0)">
						{{ __('adminlte::LangRespel.danger4') }}
					</option>

					<option value = "{{ __('adminlte::LangRespel.danger5')}}" {{ ($Respels->RespelIgrosidad == __('adminlte::LangRespel.danger5') ? 'selected' : '') }} onclick="setDanger(0)">
						{{ __('adminlte::LangRespel.danger5') }}
					</option>

					<option value = "{{ __('adminlte::LangRespel.danger6')}}" {{ ($Respels->RespelIgrosidad == __('adminlte::LangRespel.danger6') ? 'selected' : '') }} onclick="setDanger(0)">
						{{ __('adminlte::LangRespel.danger6') }}
					</option>

					<option value = "{{ __('adminlte::LangRespel.danger7')}}" {{ ($Respels->RespelIgrosidad == __('adminlte::LangRespel.danger7') ? 'selected' : '') }} onclick="setDanger(0)">
						{{ __('adminlte::LangRespel.danger7') }}
					</option>

					<option value = "{{ __('adminlte::LangRespel.danger8')}}" {{ ($Respels->RespelIgrosidad == __('adminlte::LangRespel.danger8') ? 'selected' : '') }} onclick="setDanger(0)">
			...
			<div class="col-md-6 form-group has-feedback">
				...
				<select id="selectControl0" name="SustanciaControlada" class="form-control" required>
					<option value="">{{ __('adminlte::LangRespel.select') }}</option>
					<option value="0" onclick="setNoControlada(0)" {{ ($Respels->SustanciaControlada === 0 ? 'selected' : '') }}>{{ __('adminlte::LangRespel.no') }}</option>
					<option value="1" onclick="setControlada(0)" {{ ($Respels->SustanciaControlada === 1 ? 'selected' : '') }}>{{ __('adminlte::LangRespel.yes') }}</option>
				</select>
			</div>
