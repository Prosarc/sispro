		...
		<div class="col-md-16 col-md-offset-0">
			...
			<div class="box">
				<div class="box-header">
					<h3 class="box-title">{{ __('adminlte::message.gsedeupdate') }}</h3>
				</div>
				<div class="row">
					<div class="col-md-12">
							...
							<form role="form" action="/sgeneradores/{{$GSede->GSedeSlug}}" method="POST" enctype="multipart/form-data" data-toggle="validator">
								...
								<div class="box-body">
									<div class="col-md-12 form-group">
										<label for="clientname">{{ __('adminlte::message.gener') }}</label><small class="help-block with-errors">*</small>
									...
									<div class="col-md-6 form-group">
										<label for="sedeinputname">{{ __('adminlte::message.sgenernamesede') }}</label><small class="help-block with-errors">*</small>
									...
									<div class="col-md-6 form-group">
										...
										<select class="form-control select" id="departamento" name="departamento" required>
											<option>{{ __('adminlte::message.select') }}</option>
									...
									<div class="col-md-6 form-group">
										...
										<input type="email" class="form-control" id="sedeinputemail" placeholder="{{ __('adminlte::message.emailplaceholder') }}" name="GSedeEmail" value="{{$GSede->GSedeEmail}}" required>
									</div>
									<div class="col-md-6 form-group">
										<label for="sedeinputcelular">{{ __('adminlte::message.mobile') }}</label><small class="help-block with-errors">*</small>
										<div class="input-group">
											<span class="input-group-addon">(+57)</span>
											<input type="text" class="form-control mobile" id="sedeinputcelular" placeholder="{{ __('adminlte::message.mobileplaceholder') }}" data-minlength="12" maxlength="12" name="GSedeCelular" value="{{$GSede->GSedeCelular}}" required>
										</div>
									</div>
									<div class="col-md-6 form-group">
