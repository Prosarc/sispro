		...
		<div class="col-md-16 col-md-offset-0">
			...
			<div class="box">
				<div class="box-header with-border">
					<h3 class="box-title">{{ __('adminlte::message.SGenerregistertittle') }}</h3>
				</div>
				<div class="row">
					<div class="col-md-12">
							...
							<form role="form" action="/sgeneradores" method="POST" enctype="multipart/form-data" data-toggle="validator">
								...
								<div class="box-body">
									<div class="col-md-6 form-group ">
										<label for="FK_GSede">{{ __('adminlte::message.gener') }}</label><small class="help-block with-errors">*</small>
									...
									<div class="col-md-6 form-group ">
										<label for="GSedeinputname">{{ __('adminlte::message.sgenernamesede') }}</label><small class="help-block with-errors">*</small>
									...
									<div class="col-md-6 form-group ">
										<label for="GSedeinputaddress">{{ __('adminlte::message.address') }}</label><small class="help-block with-errors">*</small>
									...
									<div class="col-md-6 form-group ">
										<label for="GSedeinputemail">{{ __('adminlte::message.emailaddress') }}</label><small class="help-block with-errors">*</small>
										<input type="email" class="form-control" id="GSedeinputemail" placeholder="{{ __('adminlte::message.emailplaceholder') }}" name="GSedeEmail" value="{{old('GSedeEmail')}}" required>
									</div>
									<div class="col-md-6 form-group">
										<label for="Respels" data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>{{ __('adminlte::message.MenuRespel') }}</b>" data-content="{{ __('adminlte::message.respels-sede-gener') }}">
									...
									<div class="col-md-6 form-group ">
										<label for="GSedeinputcelular">{{ __('adminlte::message.mobile') }}</label><small class="help-block with-errors">*</small>
										<div class="input-group">
											<span class="input-group-addon">(+57)</span>
											<input type="text" class="form-control mobile" name="GSedeCelular" id="GSedeinputcelular" data-minlength="12" value="{{old('GSedeCelular')}}" placeholder="{{ __('adminlte::message.mobileplaceholder') }}" required>
										</div>
									</div>
									<div class="col-md-6 form-group">
								...
								<div class="box box-info" >
									<div class="box-footer pull-right">
										<button type="submit" class="btn btn-success">{{ __('adminlte::message.register') }}</button>
									</div>
								</div>
							</form>
						</div>
