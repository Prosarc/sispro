							...
							<table class="table table-compact table-bordered table-striped">
								...
								<tbody>
									...
									<tr>
										...
										<td><a method='get' href='/requerimientos/{{$Requerimiento->ReqSlug}}' class='btn btn-info btn-block' title="{{ __('adminlte::message.seemoredetails')}}"><i class="fas fa-search"></i></a></td>
										<td><a method='get' href='/requerimientos/{{$Requerimiento->ReqSlug}}/edit' class='btn btn-warning btn-block'><i class="fas fa-edit"></i> <b>{{__('adminlte::message.edit')}}</b></a></td>
									</tr>
									@endforeach
								</tbody>
								{{-- <tfoot>
