						...
						<div class="box-body">
							...
							<div class="form-group col-md-6">
								...
								<select name="CargGrade" id="CargoGrade" class="form-control">
									<option value="">{{__('adminlte::message.select')}}</option>
									<option>{{__('adminlte::message.cargogradelist1')}}</option>
									<option>{{__('adminlte::message.cargogradelist2')}}</option>
									<option>{{__('adminlte::message.cargogradelist3')}}</option>
									<option>{{__('adminlte::message.cargogradelist4')}}</option>
								</select>
							</div>
							<div class="form-group col-md-6">
