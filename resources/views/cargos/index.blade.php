		...
		<div class="col-md-16 col-md-offset-0">
			<div class="box">
				<div class="box-header">
					...
					<a href="/cargos/create" class="btn btn-primary pull-right">{{__('adminlte::message.create')}}</a>
				</div>
						...
						<table id="CargosTable" class="table table-compact table-bordered table-striped">
							...
							<tbody id="readyTable">
								...
								<tr style="{{$Cargo->CargDelete === 1 ? 'color: red' : ''}}">
									...
									<td><a href='/cargos/{{$Cargo->CargSlug}}/edit' class='btn btn-warning btn-block'><i class="fas fa-edit"></i> <b>{{__('adminlte::message.edit')}}</b></a></td>
								</tr>
								@endforeach
							</tbody>
						</table>
