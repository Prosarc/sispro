			...
			<div class="col-md-16 col-md-offset-0">
				<div class="box">
					<div class="box-header">
						...
						<a href="/areas/create" class="btn btn-primary pull-right">{{ __('adminlte::message.create') }}</a>
					</div>
							...
							<table id="AreaTable" class="table table-compact table-bordered table-striped">
								...
								<tbody id="readyTable">
									...
									<tr style="{{$Area->AreaDelete === 1 ? 'color: red' : ''}}">
										<td>{{$Area->AreaName}}</td>
										<td>{{$Area->SedeName}}</td>
										<td><a href='/areas/{{$Area->AreaSlug}}/edit' class='btn btn-warning btn-block'><i class="fas fa-edit"></i> <b>{{__('adminlte::message.edit')}}</b></a></td>
									</tr>
									@endforeach
								</tbody>
							</table>
