					...
					<form role="form" id="CreateSolSer" action="/solicitud-servicio" method="POST" enctype="multipart/form-data" data-toggle="validator">
						...
						<div class="box-body">
								...
								<div id="transportadorContainer" class="row" style="background-color: #d9edf7">
									...
									<div id="typecollect" class="form-group col-md-12">
										...
										<select class="form-control" id="SolSerTypeCollect" name="SolSerTypeCollect" required="">
											...
											<option onclick="TypeCollectSede()" value="98">{{ __('adminlte::message.solsertypecollect2') }}</option>
											<option onclick="HiddenTypeCollect()" value="99">{{ __('adminlte::message.solsertypecollect1') }}</option>
											<option onclick="TypeCollectOther()" value="97">{{ __('adminlte::message.solsertypecollect3') }}</option>
										</select>
									</div>
								...
								<div class="col-md-12">
									...
									<div class="col-md-12 collapse Requerimientos" style="border: 2px dashed #00c0ef">
										...
										<div class="form-group col-md-6 col-md-offset-3" style="text-align: center;" hidden="">
											<label data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>{{ __('adminlte::message.solsernameelem') }}</b>" data-content="<p style='width: 50%'> {{ __('adminlte::message.solsernameelemdescrit') }} </p>" class="col-md-12" >
							...
							<div class="col-md-12" style="text-align: center;">
								<b>{{ __('adminlte::message.solserrespelsend') }}</b>
							</div>
							...
							<div id="AddGenerador" class="col-md-16">
								<a onclick="AgregarGenerador()" id="Agregar" class="btn btn-primary" data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b> {{ __('adminlte::message.solseraddgener') }}</b>" data-content="{{ __('adminlte::message.solseraddgenerdescrit') }}"><i class="fas fa-plus-circle"></i> {{ __('adminlte::message.solseraddgener') }}</a>
							</div>
						</div>
						<div id="ModalSupport"></div>
						<div class="box box-info">
							<div class="box-footer">
								<a onclick="$('#Submit').hasClass('disabled') ? $('#Submit').click() : submitverify()" id="Submit2" class="btn btn-success pull-right">{{ __('adminlte::message.applyfor') }}</a>
