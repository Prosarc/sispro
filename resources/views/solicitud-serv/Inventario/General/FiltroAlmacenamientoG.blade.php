...
@section('htmlheader_title','Inventario')
{{-- @endsection --}}
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">
                                ...
                                <form action="inventario/almacenamientogeneral" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <button type="submit" href="inventario/almacenamientogeneral" class="btn btn-info" style="margin: 10px 30px;" id="btn-buscar">Generar</button>
                                </form> 
                            </div>
                        </div>
                    </div>
