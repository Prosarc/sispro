                        ...
                        <table id="SolicitudservicioTable" class="table table-compact table-bordered table-striped d-none">
                            ...
                            <tbody>
                                ...
                                <tr style="{{$Servicio->SolSerDelete == 1 ? 'color: red' : ''}}">
                                    ...
                                    <td style="text-align: center;">{{$Servicio->SolResAuditoriaTipo}}</p>
                                    </td>
                                    ...
                                    @break
                                    @case('Recepcionado')
                                    <td class="text-center"><a data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" data-delay='{"show": 200}' title="<b>Status Recepcionado</b>" data-content="<p style='width: 50%'>Ingrese en las Observaciones del Servicio para validar el motivo del servicio fallido <br>Para más detalles comuníquese con su <b>Asesor Comercial</b> </p>" class='btn btn-primary'><i class='fas fa-check-circle'></i></a><br>{{$Servicio->SolSerStatus}}</td>
									</td>
                                    @break
                                    @case('Completado')
